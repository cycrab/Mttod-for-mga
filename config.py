...
def add_config(parser):
    ...
    group.add_argument("-add_residual_lr", action="store_true")
    group.add_argument("-residual_lr", type=float, default=1e-4)
    ...
    group.add_argument("-simplify", action="store_true")
